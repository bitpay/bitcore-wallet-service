...
WalletService.prototype.getStatus = function(opts, cb) {
  ...
  // Server message - For important notifications
  status.serverMessage = {
    title: 'Bitcoin Protocol Changes in Progress',
    body: 'The Bitcoin network is currently undergoing disruptions due to Bitcoin protocol changes. To avoid risk of loss, we recommend you avoid using bitcoin until these disruptions are over',
    link: 'https://blog.bitpay.com/segwit2x-and-bitpay/'
  };
