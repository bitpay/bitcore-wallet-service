...
// When trying to determine if an input is safe for spending, check no more than this many ancestors
// (each one is a request to the blockchain explorer).
Defaults.MAX_ANCESTORS_PER_INPUT_TO_VERIFY = 10;
