...
Credentials.prototype.canSign() {
  return !!this.xPrivKey;
};

Credentials.prototype.canRead() {
  return !!this.roPrivKey;
};

Credentials.prototype.canWrite() {
  return !!this.rwPrivKey;
};

Credentials.prototype.isComplete() {
